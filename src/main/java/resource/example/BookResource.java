...
public class BookResource {
    ...
    static {
        ...
        BookResource.memoryBase.put(1L, new Book((int) 1L, "Java Restful Web Services实战"));
        BookResource.memoryBase.put(2L, new Book((int) 2L, "Java EE 7 精髓"));
    }
    ...
    public Books getBooks() {
        ...
        final Set<Entry<Long, Book>> entries = BookResource.memoryBase.entrySet();
