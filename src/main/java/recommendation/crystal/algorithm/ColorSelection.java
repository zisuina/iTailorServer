...
import Jama.Matrix;
import recommendation.crystal.com.company.Cloth;
...
public class ColorSelection {
    ...
    Cloth cloth1= new Cloth("衬衫",90.4,"OL","红色",30);
    Cloth cloth2= new Cloth("T恤",100.5,"通勤","蓝色",40);
    Cloth cloth3= new Cloth("吊带",50.4,"简约","白色",20);
    Cloth cloth4= new Cloth("吊带",50.4,"简约","白色",98);
    Cloth cloth5= new Cloth("T恤",100.5,"通勤","蓝色",99);
    ArrayList<HumanData> users = new ArrayList<HumanData>();
    ArrayList<Cloth> clothes = new ArrayList<Cloth>();
    ArrayList<Cloth> user1_maked_clothes = new ArrayList<Cloth>();
    ArrayList<Cloth> user2_maked_clothes = new ArrayList<Cloth>();
    ArrayList<Cloth> similar_clothes = new ArrayList<Cloth>();
