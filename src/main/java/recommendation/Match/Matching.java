...
public class Matching {
   // Weather info = new Weather();
    ...
    public int GetColor()
    {
        ...
        calcultaTables tables = new calcultaTables();
        float [] possibility =tables.CalculateFinalTable();
        ArrayList<String> slectionClor= tables.GetSlectionColor();
        ArrayList<String> colors_name= calculateTable1.GetNamesArray();
        for (int i = 0; i < slectionClor.size(); i++) {
            System.out.println("s "+slectionClor.get(i));
        }
        for (int i = 0; i < colors_name.size(); i++) {
            System.out.println("c "+colors_name.get(i));
       ...
       // System.out.println("count: "+count);
        ...
        for(int i =0 ; i<possibility.length;i++)
        {
           ...
           // System.out.println("possibility[i]: "+possibility[i]);
            if(count< te && count>= te-possibility[i])
            {
             //   System.out.println("iii被选中颜色为:"+i);
                for(int j =0;j<colors_name.size();j++)
                {
                 //   System.out.println(colors_name.get(j));
                 //   System.out.println(slectionClor.get(i));
                    if(slectionClor.get(i).equalsIgnoreCase(colors_name.get(j)))
                    {
                        place=j;
                    }
                }
    ...
    {
        CalculateTable1 calculateTable1 = new CalculateTable1();
        float [] colorPossibility =calculateTable1.CalculateTableArray();
        calcultaTables tables = new calcultaTables();
        ArrayList<String> slectionClor= new ArrayList();
        slectionClor = tables.GetSlectionColor();
        ArrayList<String> colors_name= calculateTable1.GetNamesArray();
        ...
        ArrayList slectionclorformatch = tables.GetSlectionColor2();
        ArrayList r = calculateTable1.readColor("r");
        ArrayList g = calculateTable1.readColor("g");
        ArrayList b = calculateTable1.readColor("b");
        ...
        //float[][] test=GetArrayHSL();
        float clor_data[][] =  GetArrayHSL();
        float[][] hsb_test = GetArrayHSL();
        //色调配色
    ...
    public float[][] GetArrayHSL()
    {
        float[][] test = new float[allcolorsNum][3];
        CalculateTable1 calculateTable1 = new CalculateTable1();
        ArrayList h = calculateTable1.readColorHSL("h");
        ArrayList s = calculateTable1.readColorHSL("s");
        ArrayList b = calculateTable1.readColorHSL("b");
        for (int i = 0; i < allcolorsNum; i++) {

                test[i][0] = Float.parseFloat(String.valueOf(h.get(i)));
                test[i][1] = Float.parseFloat(String.valueOf(s.get(i)));
                test[i][2] = Float.parseFloat(String.valueOf(b.get(i)));
        }
        return test;
    }
    ...
    public void IfBodyType(String body,String style,int height,String faceshape,int age,String personality,int weight,String skinclor)
    {
                ...
                ||style.equals("波西米亚风格"))
        {
            ...
            //获取颜色以及搭配颜色
            CalculateTable1 calculateTable1 = new CalculateTable1();
            ArrayList colors_name =calculateTable1.GetNamesArray();
            int color_num =GetColor();
